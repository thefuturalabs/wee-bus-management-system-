...
class UserProfilePage extends StatefulWidget {
  ...
  @override
  State<UserProfilePage> createState() => _RtoProfilePageState();
}

class _RtoProfilePageState extends State<UserProfilePage> {
  ...
  getProfileDetails() async {
    ...
    final data =
        await Services.postData({'user_id': uid}, 'view_user_profile.php');
    nameController.text = data['name'];
    emailController.text = data['email'];
    phoneController.text = data['mobile'];
    placeController.text=data['district'];
