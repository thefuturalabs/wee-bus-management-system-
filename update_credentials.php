...
$data=mysqli_query($con,"select * from login where type='admin'");
$row = mysqli_fetch_assoc($data);
if (isset($_POST['submit'])) {
    $username = $_POST['username'];
    $password = $_POST['password'];

    $query =   mysqli_query($con,"UPDATE `login` SET `username`='$username',`password`='$password' WHERE type='admin'");
    if ($query) {
    ...
    <section class="login-content">
      ...
      <div class="login-box">
        <form class="login-form" method="post" >
          <h3 class="login-head"><i class="fa fa-lg fa-fw fa-user"></i>Update Credentials</h3>
